  ...
  Future<void> init() async {
    ...
    sl.registerLazySingleton(() => FetchInstallationJobsUsecase(repository: sl(),),);
    ...
    sl.registerFactory(
        ...
        fetchJobsUsecase: sl(),
        fetchInstallationJobsUsecase: sl(),
        respondToJobUsecase: sl(),
        acceptInstallationUsecase: sl(),
        rejectInstallationUsecase: sl(),
      ),
    );
    sl.registerFactory(
          () => TechnicianHistoryBloc(
        fetchTechnicianHistoryUsecase: sl(),
      ),
    );
    ...
    sl.registerFactory(
        ...
        completeInstallationUsecase: sl(),
      ),
    );
  }
